...
import 'package:url_launcher/url_launcher.dart'; // Keep if using url_launcher for calls
...
import '../models/user.dart' as app_user; // Alias if User conflicts
import '../services/firebase_service.dart';
import '../services/auth_service.dart'; // Assuming AuthService provides user role
import 'jobs/create_job_screen.dart';
import 'jobs/quick_job_request_screen.dart'; // Keep if using quick request
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          CircleAvatar(
            radius: 20,
            backgroundColor: colorScheme.surfaceVariant, // Themed background
                        ...
                        decoration: BoxDecoration(
                          color: isAvailable
                              ? dialogColorScheme.primaryContainer
                                  .withOpacity(0.2)
                              : dialogColorScheme.surfaceVariant
                                  .withOpacity(0.5),
                          border: Border.all(
                              color: isAvailable
                                  ? dialogColorScheme.primaryContainer
